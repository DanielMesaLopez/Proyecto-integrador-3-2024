...
const Rol = () => {
  ...
  //metodo post
  const add = () => {
    Axios.post("http://localhost:3300/rolCreado", {
      id_rol: id_rol,
  ...
  //metodo get
  const getRol = () => {
    Axios.get("http://localhost:3300/Consultar/Rol").then((response) => {
  ...
  const update = () => {
    Axios.put("http://localhost:3300/Actualizar/rol", {
      id_rol: id_rol,
      descripcion: descripcion,
      nombre: nombre,
    }).then(() => {
  ...
  const deleteRol = (val) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Axios.delete(`http://localhost:3300/Delete/rol/${val.id_rol}`)
          .then(() => {
            getRol();
            limpiar();
            Swal.fire({
