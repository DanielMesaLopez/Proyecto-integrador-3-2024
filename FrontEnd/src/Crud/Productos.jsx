...
const Productos = () => {
  ...
  //metodo post
  const add = () => {
    Axios.post("http://localhost:3300/Insertar/Producto", {
  ...
  //metodo get
  const getProductos = () => {
    Axios.get("http://localhost:3300/Consultar/Producto").then((response) => {
  ...
  const update = () => {
    Axios.put("http://localhost:3300/Actualizar/Producto", {
      id_producto: id_producto,
      id_categoria: id_categoria,
      descripcion_producto: descripcion_producto,
      imagen: imagen,
  ...
  const deleteProducto = (val) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Axios.delete(`http://localhost:3300/Delete/Producto/${val.id_producto}`)
          .then(() => {
            getProductos();
            limpiar();
            Swal.fire({
        ...
        <div className="card-body">
          ...
          <div className="input-group mb-3">
            ...
            <input
              ...
              className="form-control"
              placeholder="Ingrese la imagenn"
              aria-label="Username"
              aria-describedby="basic-addon1"
            />
          </div>
